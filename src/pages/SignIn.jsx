    ...
    <div style={{margin: '20px'}}>
      <form onSubmit={handleSubmit}>
        ...
        <input type="password" name='password' value={userInfo.password} placeholder="패스워드"
          onChange={handleChange} /><br />
        <div>
          <Link to='/' style={{ textDecoration: 'none', color: 'inherit', padding: '10px 20px', backgroundColor: 'gray', borderRadius: '5px', border: 'none', cursor: 'pointer', display: 'inline-block' }}>
            로그인
          </Link>
        </div>
